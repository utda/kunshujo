/*
 * Leaflet.Dialog
 * MIT License, Copyright (c) 2017 NBT Solutions
 */
/* Modified by Jun HOMMA (@2SC1815J) */
L.Control.Dialog = L.Control.extend({
  ...
  destroy: function(){
    ...
    //this._map.fire('dialog:destroyed', this); //this._map is already null
    //same issue, https://github.com/NBTSolutions/Leaflet.Dialog/issues/18
    return this;
  },
  ...
  _initLayout: function(){
    ...
    L.DomUtil.setPosition(this._container, L.point(this.options.transform[0], this.options.transform[1]));
    var draggable = new L.Draggable(this._container, this._grabberNode).on('dragend', function() {
  ...
  _handleTouchResizeStart: function(e){
    this._oldMousePos.x = e.touches[0].pageX;
    this._oldMousePos.y = e.touches[0].pageY;

    L.DomEvent.on(this._map._container, 'touchmove', this._handleTouchMove, this);
    L.DomEvent.on(this._map._container, 'touchend', this._handleTouchEnd, this);
  ...
  _handleTouchMove: function(e){
    var diffX = e.touches[0].pageX - this._oldMousePos.x,
      diffY = e.touches[0].pageY - this._oldMousePos.y;
  ...
  _handleTouchEnd: function(){
    L.DomEvent.off(this._map._container, 'touchmove', this._handleTouchMove, this);
    L.DomEvent.off(this._map._container, 'touchend', this._handleTouchEnd, this);
